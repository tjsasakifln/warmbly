        ...
        <div className="grid grid-cols-2 sm:grid-cols-5 gap-2">
          {stats.map((s) => (
            <div key={s.label} className="rounded-md border border-slate-200 bg-white px-2.5 py-2">
              ...
              <div className="text-lg font-semibold text-slate-900 tabular-nums" data-testid={`confenge-stat-${s.label.toLowerCase()}`}>
                {s.value}
              </div>
            </div>
          ))}
            ...
            <div className="p-3 grid md:grid-cols-2 gap-4">
              <div className="space-y-2 text-[12.5px]">
                <div>
                  ...
                  <div className="font-medium text-slate-900" data-testid="confenge-company">{company}</div>
                </div>
                <div>
                ...
                <div>
                  ...
                  <div data-testid="confenge-channel-service">{current.channel} · {current.service_code || "—"}</div>
                </div>
                <div>
