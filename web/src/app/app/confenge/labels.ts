const STATE_LABELS: Record<string, string> = {
  ...
  INBOUND_NOW: "Inbound agora",
  SEND_EMAIL: "Preparar e-mail",
  CALL: "Ligação",
  SUPPRESSED: "Suprimido",
  QUALIFIED_CONVERSATION: "Conversa qualificada",
  ...
  RESOLVED_NO_ACTION: "Resolvido sem ação",
  ALERT_FAILED: "Alerta falhou",
  DUPLICATE: "Duplicado",
  NOT_A_LEAD: "Não é lead",
  SPAM: "Spam",
  TEST: "Teste",
  OTHER: "Outro",
  UNKNOWN: "UNKNOWN",
