...
Common reason codes include `feed_missing`, `feed_stale`, `account_ineligible`, `target_fit_stale`, `account_do_not_contact`, `account_blocked`, `commercial_context_expired`, `recipient_missing`, `recipient_invalid`, `recipient_demo_or_fixture`, `recipient_opt_out`, `recipient_hard_bounce`, `recipient_suppressed`, `provenance_tainted`, `recipient_not_send_ready`, `recipient_domain_mismatch`, `recipient_evidence_date_missing`, `recipient_evidence_stale`, `generic_mailbox_not_allowed`, `incomplete_copy_context`, and `cohort_capacity_reached`.
