...
Version N+1 is born with no validation, no review, no approval and no scheduling. It queues nothing, sends nothing and resumes nothing. Validation and individual approval are taken again on the new version; APPROVE then schedules the exact reviewed message.
