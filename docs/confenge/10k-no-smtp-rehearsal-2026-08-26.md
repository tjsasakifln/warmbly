...
recovery**. Dispatch was never invoked, no application service was started, no
SMTP provider was configured, and `SENT` remained zero. This is not transport
...
`ProcessDispatchQueueOnce` or any provider transport.
