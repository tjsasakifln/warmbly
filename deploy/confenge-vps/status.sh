...
DELEGATED_RUNWAY="${CONFENGE_DELEGATED_FIRST_TOUCH_RUNWAY_TARGET:-100}"
...
echo "DELEGATED_FIRST_TOUCH_RUNWAY_TARGET=${DELEGATED_RUNWAY} (scheduling only; no transport authority)"
